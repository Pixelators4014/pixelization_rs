...
mkdir -p ./opt/nvidia/
mkdir -p ./usr/share/
cp /usr/bin/tegrastats ./usr/bin/
cp /tmp/argus_socket ./tmp/
...
cp /usr/lib/aarch64-linux-gnu/tegra ./usr/lib/aarch64-linux-gnu/
cp /usr/src/jetson_multimedia_api ./usr/src/
cp /opt/nvidia/nsight-systems-cli ./opt/nvidia/
cp /opt/nvidia/vpi2 ./opt/nvidia/
cp /usr/share/vpi2 ./usr/share/
